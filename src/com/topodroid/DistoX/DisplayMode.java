...
class DisplayMode
{
  ...
  static final int DISPLAY_SCALE_REF = 0x20; // whether to display the scale reference bar on not 
  static final int DISPLAY_SECTION = 0x0d;   // 0x08 | 0x04 | 0x01
  static final int DISPLAY_ALL     = 0x2f;   
