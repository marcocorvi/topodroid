...
// ----------------------------------------------------------------------------
    ...
    {
      ArrayList< TdmSurvey > surveys = TopoDroidApp.mTdmConfig.mViewSurveys;
      if ( surveys == null ) return;
      // TdmConfig config = mApp.mConfig;
      ArrayList< TdmEquate > equates = TopoDroidApp.mTdmConfig.mEquates;
  ...
  void makeEquate( String st1, String st2 )
  {
    ...
    TopoDroidApp.mTdmConfig.addEquate( equate );
    updateViewEquates();
  }
  ...
  {
    mDrawingSurface.addEquates( TopoDroidApp.mTdmConfig.mEquates );
  }
  ...
  { 
    ...
    if ( k1 < mNrButton1 && b0 == mButton1[k1++] ) {  // EQUATE
      ...
      (new TdmEquatesDialog( this, TopoDroidApp.mTdmConfig, this )).show();
