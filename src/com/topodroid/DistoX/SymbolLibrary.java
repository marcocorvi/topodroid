...
public class SymbolLibrary
{
  ...
  final static String ARCHEO       = "archeo";
  final static String COLUMN       = "column";
  final static String CURTAIN      = "curtain";
  final static String FLOWSTONE    = "flowstone";
  final static String DANGER       = "danger";
  final static String DIG          = "dig";
  final static String GRADIENT     = "gradient";
  final static String GUANO        = "guano";
  final static String ENTRANCE     = "entrance";
  final static String HELICTITE    = "helictite";
  final static String ICE          = "ice";
  final static String MUD          = "mud";
  ...
  final static String SODA_STRAW   = "soda-straw";
