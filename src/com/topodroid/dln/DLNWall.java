...
public class DLNWall
{
  ...
  public DLNWall( Point2D p0, Point2D p1 )
  {
    P0 = p0;
    P1 = p1;
    P01 = P1.sub( P0 );
  ...
  public int size() { return mTri.size(); }

  public DLNTriangle getTriangle( int k ) { return mTri.get(k); }

  public DLNSideList getBorderHead() { return mHull.get(0); }

  public int hullSize() { return mHull.size(); }
