...
public class Cave3DFix extends Vector3D
{
  ...
  { 
    ...
    // return isWGS84()? Geodetic.meridianRadiusEllipsoid( latitude, a_ellip ) : 1.0; // FIXME_ELLIPSOID
  }
  ...
  { 
    ...
    // return isWGS84()? Geodetic.parallelRadiusEllipsoid( latitude, a_ellip ) : 1.0; // FIXME_ELLIPSOID
  }
  ...
  public double latToNorth( double lat, double h_ell ) 
  {
    ...
    // double s_radius = Geodetic.meridianRadiusEllipsoid( lat, h_ell ); // FIXME_ELLIPSOID
  ...
  public double lngToEast( double lng, double lat, double h_ell, double north )
  {
    ...
    // double e0_radius = Geodetic.parallelRadiusExact( latitude, a_ellip ); // FIXME_ELLIPSOID
    ...
    TDLog.v(" lng to E radius = " + e_radius + " north " + north + " conv " + conv );
    return hasWGS84()? x + (lng - longitude) * e_radius * (1 + north*conv) : 0.0;
    // return hasWGS84()? x + (lng * e_radius - longitude * e0_radius) * (1 + north*conv) : 0.0; // FIXME_ELLIPSOID
  }
