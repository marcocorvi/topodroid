...
public class PTFile
{
  ...
  static float ROLL_2_DEG( float r )
  {
    ...
    public int tripCount() { return _trips.size(); }
    public PTTrip getTrip( int k ) { return _trips.get(k); }
 
    public int shotCount() { return _shots.size(); }
    public PTShot getShot( int k ) { return _shots.get(k); }
 
    public int refCount() { return _references.size(); }
    public PTReference getRef( int k ) { return _references.get(k); }
 
    public PTMapping getOverview() { return _overview; }
    public PTDrawing getOutline()  { return _outline;  }
    public PTDrawing getSideview() { return _sideview; }
...
*/
     ...
     * @return trip index
     */
    public int addTrip( int y, int m, int d, float declination, String comment )
    {
      PTTrip trip = new PTTrip();
      trip.setTime( y, m, d );
     ...
     */
    public int addShot( short trip, String from, String to, 
                 float distance,    // [m]
     ...
     */
    public int addReference( String station, float e, float n, float a, String comment )
    {
      int e0 = (int)(e * 1000);
      int n0 = (int)(n * 1000);
      int a0 = (int)(a * 1000);
