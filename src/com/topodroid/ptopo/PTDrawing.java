...
public class PTDrawing
{
    ...
    public PTMapping mapping() { return _mapping; }

    public int elementNumber() { return _elements.size(); }

    public PTElement getElement( int k ) { return (PTElement)_elements.get(k); }
