/* @file DiscoXConst.java
 *
 * @author marco corvi
 * @date nov 2011
 *
 * @brief TopoDroid DioscoX bluetooth LE constants and commands - copyed from SAP
 * --------------------------------------------------------
...
public class DiscoXConst 
{
  // static final UUID CCCD = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");

  /**  no need to define new const
   * as long as DiscoX does not extend SAP functions
   */
  ...
  // static final String SAP6_DSCR_NOTIFICATION   = "00002902-0000-1000-8000-00805f9b34fb"; // SAP-6 notification descriptor
  ...
  // static final public UUID SAP6_DSCR_NOTIFICATION = UUID.fromString( SAP6_DSCR_NOTIFICATION );
