...
public class DistoXBLEConst
{
  ...
  static final String DISTOXBLE_CHRT_READ_UUID_STR  = "6e400003-b5a3-f393-e0a9-e50e24dcca9e"; //  DistoXBLE receive (from pony to app)
  static final String DISTOXBLE_CHRT_WRITE_UUID_STR = "6e400002-b5a3-f393-e0a9-e50e24dcca9e"; // DistoXBLE send (from app to pony)
