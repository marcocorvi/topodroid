...
public class FirmwareUtils
{
  ...
  static int getHardware( int fw ) 
  {
    ...
    if ( fw == 2700 || fw == 2701 || fw == 2710 ) return HW_TIAN;
    return HW_NONE;
  }
  ...
  public static boolean firmwareChecksum( int fw_version, File fp )
  {
    ...
    switch ( fw_version ) {
      ...
      case 2710: return ( checksum == 0x5efcf762 ); // 20240703
    }
    return false;
  }
  ...
  private static int readFirmwareTian( byte[] buf )
  {
    ...
    // 20240703: 4803 4685 f003 fc72 4800 4700 08d5 0800
    ...
    if ( buf[4] == (byte)0x03 && buf[5] == (byte)0xf0 && buf[6] == (byte)0x72 && buf[7] == (byte)0xfc ) return 2710; // 20240703
    return -99; // failed on byte[7]
  }
}
