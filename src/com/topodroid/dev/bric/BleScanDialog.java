                 ...
                 View.OnClickListener
{
  ...
  public void onItemClick(AdapterView<?> parent, View view, int pos, long id)
  {
    ...
    // Log.v( "BRIC", "scan dialog on item click: " + BleUtils.deviceToString( device ) );
  ...
  {
    // Log.v( "BLEX", "scan dialog on click" );
