...
class BricDebug
{
  ...
  {
    Log.v("DistoX-BLE-B", "BRIC debug MeasPrim: " + bytes.length + " date " 
  ...
  {
    Log.v("DistoX-BLE-B", "BRIC debug MeasMeta: " + bytes.length + " Idx " 
  ...
  {
    Log.v("DistoX-BLE-B", "BRIC debug MeasErr: " + bytes.length + " Err1 " 
  ...
  {
    if ( bytes != null ) {
      Log.v("DistoX-BLE-B", "BRIC debug: " + msg + " " + BleUtils.bytesToString( bytes ) );
    }
  }
