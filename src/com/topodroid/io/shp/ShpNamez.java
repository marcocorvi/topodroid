 ...
 * @date mar 2019
 *
 * @brief TopoDroid drawing: shapefile 3D name
 * --------------------------------------------------------
...
public class ShpNamez extends ShpObject
{
  static final private String[] flag_string = { " ", "F", "P" }; 
 
  public ShpNamez( String subdir, String path, List< String > files ) // throws IOException
  {
    super( SHP_POINTZ, subdir, path, files );
  }

  // write headers for NAMEZ
  public boolean writeNames( List< SavedStation > pts ) throws IOException
  {
  ...
  private void setBoundsStations( List< SavedStation > pts ) 
  {
    if ( pts.size() == 0 ) {
